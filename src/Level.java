...
public class Level {
    ...
    public Level(int levelNum){
        ...
        if (levelNum == 1){
            enemies.add(new Enemies("DarrellTheDragon",0,"Pictures/Enemies/Fire World/Fire Dragon",5,"Fire Buff"));
            ...
            enemies.add(new Enemies("Chicken Mans",50,"Pictures/Enemies/Sky World/Sky Dragon",4,"Sky Buff"));
