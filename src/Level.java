...
public class Level {
    ...
    public Level(int levelNum){
        ...
        if (levelNum == 1){
            ...
            enemies.add(new Enemies("RandyTheRacoon", 10, "Pictures/Enemies/Fire World/Raccoon", 4,"Fire Buff","Pictures/Enemies/Enemy Attack Animation",10));
            ...
            enemies.add(new Enemies("Beefy Mans",20,"Pictures/Enemies/Ice World/Ice Dragon",4,"Ice Buff","Pictures/Enemies/Enemy Attack Animation 2",7));
            enemies.add(new Enemies("PauleneThePenguin",20,"Pictures/Enemies/Ice World/Penguin",8,"Ice Buff","Pictures/Enemies/Enemy Attack Animation 2",7));
            enemies.add(new Enemies("Kevin", 25, "Pictures/Enemies/Ice World/Yeti",4,"Ice Buff", "Pictures/Enemies/Enemy Attack Animation 2",7));
            LevelBack=IceBack;
        }
        else if(levelNum == 3){
            enemies.add(new Enemies("Chicken Mans",25,"Pictures/Enemies/Sky World/Sky Dragon",4,"Sky Buff", "Pictures/Enemies/Enemy Attack Animation 3",22));
            ...
            enemies.add(new Enemies("Mom Mans",50,"Pictures/Enemies/Water World/Water Dragon",4,"Water Buff","Pictures/Enemies/Enemy Attack Animation 4",7));
            enemies.add(new Enemies("Nemo",500,"Pictures/Enemies/Water World/Shark",7,"Water Buff","Pictures/Enemies/Enemy Attack Animation 4",7));
            enemies.add(new Enemies("WaterHorsey",100, "Pictures/Enemies/Water World/Seahorse",6,"Water Buff","Pictures/Enemies/Enemy Attack Animation 4",7));
            LevelBack=WaterBack;
        }
    }
